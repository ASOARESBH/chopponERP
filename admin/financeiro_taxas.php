...
<div class="page-header">
    ...
    <button class="btn btn-primary" onclick="openModalForma()">
...
<div id="formaModal" class="modal">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <span class="close" onclick="closeModalForma()">&times;</span>
        </div>
        <form method="POST" id="formaForm">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" onclick="closeModalForma()">Cancelar</button>
