                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group btn-group-sm">
                                    ...
                                    <button class="btn btn-success" onclick="conferirRoyalty(<?= $r['id'] ?>)" title="Gerar Link">
        ...
        <div class="modal-body">
            <form id="formNovoRoyalty" method="POST" action="">
                ...
                <div class="row">
                    <!-- Tipo de Cobrança -->
                    <div class="col-md-6 mb-3">
                        <label class="form-label required">Tipo de Cobrança</label>
                        <div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="tipo_cobranca" 
                                       id="tipo_stripe" value="stripe" checked>
                                <label class="form-check-label" for="tipo_stripe">
                                    <i class="fab fa-stripe"></i> Stripe
                                </label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="tipo_cobranca" 
                                       id="tipo_cora" value="cora">
                                <label class="form-check-label" for="tipo_cora">
